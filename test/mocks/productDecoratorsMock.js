...
var stubP360 = sinon.stub();


function proxyModel() {
    return {
        mocks: proxyquire('../../cartridges/int_royalcyber_product360/cartridge/models/product/decorators/index', {
            ...
            '*/cartridge/models/product/decorators/p360': stubP360
        }),
        stubs: {
            stubBase: stubBase,
            stubPrice: stubPrice,
